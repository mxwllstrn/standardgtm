...
// IMPORTANT: Make sure this matches the table name you created for newsletter subscribers
const TABLE_NAME = 'Newsletter Subscribers'; 

// Handle POST requests for newsletter signups
export async function POST(request: Request) {
  try {
    ...
    console.error('Error submitting newsletter signup to Airtable:', error);
