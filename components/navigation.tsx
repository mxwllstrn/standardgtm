      ...
      <div className="mx-auto max-w-full px-4 sm:px-5 lg:px-10">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            <Link
              href="/contact"
              className="text-md font-medium transition-colors text-neutral-800 bg-neutral-100 px-2 h-[32px] rounded-sm items-center flex hover:bg-neutral-200"
            >
              Work With Us
            </Link>
            <Link
            ...
            <Link
              href="https://linkedin.com/in/m-stern"
              target="_blank"
              className="text-md/2 bg-neutral-100 text-neutral-950 rounded-sm h-[32px] w-[32px] flex items-center text-center hover:bg-neutral-200"
            >
              <Linkedin className="h-4 w-4 inline-flex mx-auto" />
            </Link>
          </div>
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Link
                    ...
                    className="bg-neutral-100 text-neutral-950 rounded-sm h-[40px] w-[40px] flex items-center text-center hover:bg-neutral-200"
                  >
                    <Linkedin className="h-5 w-5 inline-flex mx-auto" />
                  </Link>
                </div>
              </div>
            </div>
