...
export default function Titlebar({ pageSuper = "", pageTitle = "", pageDescription = "", bgColor = "" }: TitlebarProps) {
  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-20 px-4 sm:px-5 lg:px-10">
      <div className={`rounded-xs ${bgColor ? bgColor : ""}`}>
        <div className="mx-auto max-w-3xl py-12">
          ...
          <br />
          <h2 className="text-md text-center tracking-tight sm:text-4xl/8 md:text-[1.25rem]/8 text-neutral-950 max-w-lg mx-auto">{pageDescription}</h2>
        </div>
      </div>
    </section>
  )
